...
DATABASES = {
    'default': {
        ...
        'NAME': PROJECT_ROOT + '/epl/timemap.db',        # Or path to database file if using sqlite3.
...
GLOBAL_URLS = {} 
GLOBAL_URLS['email_logo'] = "http://something.com"
...
SECRET_KEY = 'yh7slf3f@h%^@jm6jyy*4s3*gs#r6*nse4=7=gis8@!p#-*^0k'
