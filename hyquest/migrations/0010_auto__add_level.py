...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Level'
        db.create_table('hyquest_level', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('level_name', self.gf('django.db.models.fields.CharField')(default='1', max_length='40')),
            ('required_exp', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('hyquest', ['Level'])


    def backwards(self, orm):
        # Deleting model 'Level'
        db.delete_table('hyquest_level')
    ...
    models = {
        ...
        'hyquest.level': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level_name': ('django.db.models.fields.CharField', [], {'default': "'1'", 'max_length': "'40'"}),
            'required_exp': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'hyquest.quest': {
        ...
        'hyquest.questset': {
            ...
            'depends_on': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hyquest.QuestSet']", 'null': 'True', 'blank': 'True'}),
