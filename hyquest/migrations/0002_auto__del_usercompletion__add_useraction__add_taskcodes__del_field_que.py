...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskCodes'
        db.create_table('hyquest_taskcodes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hyquest.Task'])),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('uses_remaining', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('hyquest', ['TaskCodes'])

        # Deleting field 'Quest.active'
        db.delete_column('hyquest_quest', 'active')

        # Adding field 'Quest.quest_set'
        db.add_column('hyquest_quest', 'quest_set',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['hyquest.QuestSet']),
                      keep_default=False)

        # Adding field 'QuestSet.active'
        db.add_column('hyquest_questset', 'active',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TaskCodes'
        db.delete_table('hyquest_taskcodes')

        # Adding field 'Quest.active'
        db.add_column('hyquest_quest', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Quest.quest_set'
        db.delete_column('hyquest_quest', 'quest_set_id')

        # Deleting field 'QuestSet.active'
        db.delete_column('hyquest_questset', 'active')
