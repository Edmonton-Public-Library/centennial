...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskCode'
        db.create_table('hyquest_taskcode', (
        ...
        db.send_create_signal('hyquest', ['TaskCode'])

        # Deleting field 'Task.taskcode'
        db.delete_column('hyquest_task', 'taskcode')

        # Adding field 'Task.taskinfo'
        db.add_column('hyquest_task', 'taskinfo',
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TaskCode'
        db.delete_table('hyquest_taskcode')


        # User chose to not deal with backwards NULL issues for 'Task.taskcode'
        raise RuntimeError("Cannot reverse this migration. 'Task.taskcode' and its values cannot be restored.")
        # Deleting field 'Task.taskinfo'
        db.delete_column('hyquest_task', 'taskinfo')
