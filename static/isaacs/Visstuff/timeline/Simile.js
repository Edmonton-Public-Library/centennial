...
var elmtCopyright=Timeline.Graphics.createTranslucentImage(doc,Timeline.urlPrefix+(this.isHorizontal()?imageURLPrefix+"/copyright-vertical.png":imageURLPrefix+"copyright.png"));
...
message.contentDiv.innerHTML="<img src='"+Timeline.urlPrefix+imageURLPrefix+"/progress-running.gif' /> Loading...";
