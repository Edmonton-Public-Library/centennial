...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.branch'
        db.alter_column('timemap_story', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timemap.Branch'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Story.branch'
        raise RuntimeError("Cannot reverse this migration. 'Story.branch' and its values cannot be restored.")
