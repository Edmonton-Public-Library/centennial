...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.btype'
        db.add_column('timemap_branch', 'btype',
                      self.gf('django.db.models.fields.CharField')(default='B', max_length=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Branch.btype'
        db.delete_column('timemap_branch', 'btype')
