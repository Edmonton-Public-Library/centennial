...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BibliocommonsLink.user'
        db.add_column('centennial_bibliocommonslink', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BibliocommonsLink.user'
        db.delete_column('centennial_bibliocommonslink', 'user_id')
